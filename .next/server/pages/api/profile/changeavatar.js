...
(() => {
var exports = {};
exports.id = "pages/api/profile/changeavatar";
exports.ids = ["pages/api/profile/changeavatar"];
exports.modules = {
...
/***/ "(api)/./pages/api/profile/changeavatar.js":
/*!*******************************************!*\
  !*** ./pages/api/profile/changeavatar.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ handler)\n/* harmony export */ });\n/* harmony import */ var utils_Db_connection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! utils/Db_connection */ \"(api)/./utils/Db_connection.js\");\n/* harmony import */ var models_UsersModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! models/UsersModel */ \"(api)/./models/UsersModel.js\");\n/* harmony import */ var middlewares_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! middlewares/auth */ \"(api)/./middlewares/auth.js\");\n\n\n\n(0,utils_Db_connection__WEBPACK_IMPORTED_MODULE_0__.Db_connect)();\nfunction handler(req, res) {\n    switch(req.method){\n        case \"PATCH\":\n            changeavatar(req, res);\n    }\n};\n;\nasync function changeavatar(req, res) {\n    const user = await (0,middlewares_auth__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(req, res);\n    if (!user) return res.status(401).json({\n        error: \"Unauthenticated user\"\n    });\n    const base64 = req.body;\n    if (!base64) return res.status(400).json(\"file not found\");\n    await models_UsersModel__WEBPACK_IMPORTED_MODULE_1__[\"default\"].findByIdAndUpdate({\n        _id: user._id\n    }, {\n        avatar: base64\n    });\n    res.status(200).json({\n        success: \"avatar changed\"\n    });\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/profile/changeavatar.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/profile/changeavatar.js"));
