        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div className="collapse navbar-collapse" id="navbarNav" >
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <Link href="/cart"><a className={`${styles.navlink} nav-link` + isActive('/cart')} ><i class="fa-regular fa-cart-shopping position-relative"></i><span style={{backgroundColor: "red", padding: '2px 5px', borderRadius: '50%', left: '12px', top: '-17px'}} className="text-white position-absolute">{cart.length}</span>Cart</a></Link>
                    </li>
                    {
